<template>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <div class="relative ml-3">
                ...
                <div v-if="profileMenuOpen" @click.away="profileMenuOpen = false"
                  ...
                  <a href="#" @click="logout" class="block px-4 py-2 text-md text-green-700" role="menuitem"
  ...
  <script lang="ts">
  import { useMyUserLoguedStore } from '~/stores/userLoguedStore'; 
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const userName: Object = computed(() => {
        if (store.user) {
